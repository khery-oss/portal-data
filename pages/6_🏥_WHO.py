...
st.markdown(
    "Eksplorasi indikator kesehatan publik, regulasi tembakau, dan modal manusia (*human capital*) Indonesia resmi dari "
...
# KATALOG INDIKATOR RESMI WHO GHO (DIPERLUAS DENGAN INDIKATOR KHUSUS TEMBAKAU & KESEHATAN)
WHO_CATALOG = {
    # --- 1. Tobacco & Smoking Indicators (Khusus Tembakau) ---
    "Age-standardized prevalence of tobacco smoking among persons aged 15 years and older (%)": {
        "code": "M_GBD_TOBACCO", "kategori": "1. Tobacco Control & Smoking", "unit": "%",
        "desc": "Age-standardized prevalence of current tobacco smoking among persons aged 15+ years."
    },
    "Prevalence of current tobacco use among adolescents aged 13-15 years (%)": {
        "code": "TOB_PASSED_YOUTH", "kategori": "1. Tobacco Control & Smoking", "unit": "%",
        "desc": "Percentage of adolescents aged 13-15 years who currently use any tobacco product."
    },
    "Age-standardized prevalence of current cigarette smoking among persons aged 15 years and older (%)": {
        "code": "TOB_WHOSIS_99", "kategori": "1. Tobacco Control & Smoking", "unit": "%",
        "desc": "Prevalence of daily and non-daily cigarette smoking among adults."
    },
    "Total tax on cigarettes as a percentage of retail price (%)": {
        "code": "TOB_TAX_SHARE", "kategori": "1. Tobacco Control & Smoking", "unit": "% of Retail Price",
        "desc": "Total taxes (excise, VAT, import duties) as a percentage of the retail price of the most popular brand of cigarettes."
    },

    # --- 2. Life Expectancy & Mortality ---
    "Life expectancy at birth (years)": {
        "code": "WHOSIS_000001", "kategori": "2. Life Expectancy & Mortality", "unit": "Years",
        "desc": "Average number of years that a newborn is expected to live if current mortality rates apply."
    },
    "Healthy life expectancy (HALE) at birth (years)": {
        "code": "WHOSIS_000002", "kategori": "2. Life Expectancy & Mortality", "unit": "Years",
    ...
    "Probability (%) of dying between exact ages 30 and 70 from cardiovascular disease, cancer, diabetes, or chronic respiratory disease": {
        "code": "NCDMORT3070", "kategori": "2. Life Expectancy & Mortality", "unit": "%",
    ...
    "Adult mortality rate (probability of dying between 15 and 60 years per 1,000 population)": {
        "code": "WHOSIS_000007", "kategori": "2. Life Expectancy & Mortality", "unit": "Per 1,000 Population",
    ...
    "Under-five mortality rate (probability of dying by age 5 per 1,000 live births)": {
        "code": "MDG_0000000007", "kategori": "3. Child & Maternal Health", "unit": "Per 1,000 Live Births",
    ...
    "Infant mortality rate (probability of dying between birth and exact age 1 per 1,000 live births)": {
        "code": "MDG_0000000001", "kategori": "3. Child & Maternal Health", "unit": "Per 1,000 Live Births",
        "desc": "Probability of dying between birth and exact age 1."
    },
    "Neonatal mortality rate (per 1,000 live births)": {
        "code": "WHOSIS_000003", "kategori": "3. Child & Maternal Health", "unit": "Per 1,000 Live Births",
        "desc": "Probability of dying during the first 28 completed days of life per 1,000 live births."
    },
    "Maternal mortality ratio (per 100,000 live births)": {
        "code": "MDG_0000000026", "kategori": "3. Child & Maternal Health", "unit": "Per 100,000 Live Births",
    ...
    "Stunting prevalence among children under 5 years (%)": {
        "code": "NUTRITION_STUNTING_PREV", "kategori": "4. Nutrition & Growth", "unit": "%",
    ...
    "Wasting prevalence among children under 5 years (%)": {
        "code": "NUTRITION_WASTING_PREV", "kategori": "4. Nutrition & Growth", "unit": "%",
    ...
    "Out-of-pocket expenditure as percentage of current health expenditure (CHE) (%)": {
        "code": "SH_XPD_OOPC_CH_ZS", "kategori": "7. UHC & Health Financing", "unit": "% of Current Health Exp.",
