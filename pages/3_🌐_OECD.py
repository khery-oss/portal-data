...
st.write(
    "Comprehensive macro-economic, labor, social, demographic, environmental, and fiscal indicators for **Indonesia** "
    "based entirely on official databases and publications of the **OECD (Organization for Economic Co-operation and Development)**."
)

# KATALOG RESMI OECD KHUSUS INDONESIA (100% MURNI DARI ARSIP PUBLIKASI RESMI OECD)
OECD_CATALOG = {
    ...
    "Foreign Direct Investment (FDI Inflows)": {
        "kategori": "1. Economic Growth & Output", "unit": "% of GDP", "oecd_code": "FDI / INFLOW_PDB",
        "desc": "Net inward direct investment flows by foreign investors relative to national GDP, based on OECD International Direct Investment Statistics.",
        "source_url": "https://data-explorer.oecd.org/",
    ...
    "Labor Productivity Growth": {
        "kategori": "3. Labor Market", "unit": "Annual % Change", "oecd_code": "PDB_LV / PROD_GROWTH",
        "desc": "Growth rate of GDP per person employed, reflecting overall efficiency of labor utilization in the economy.",
        "source_url": "https://data-explorer.oecd.org/",
