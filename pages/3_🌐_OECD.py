...
st.set_page_config(page_title="OECD Comprehensive Data - Indonesia", layout="wide")

st.title("🌐 Portal Data OECD (Direktori Lengkap Indonesia)")
st.write(
    "Eksplorasi komprehensif seluruh indikator lintas sektor resmi **OECD** "
    "untuk wilayah **Indonesia**, mencakup ekonomi, sosial, lingkungan, tata kelola, hingga perpajakan."
)

# KATALOG DIREKTORI LENGKAP OECD KHUSUS INDONESIA
OECD_CATALOG = {
    # --- 1. Economy & Growth ---
    "Real GDP Growth Rate": {
        "kategori": "1. Economy", "unit": "%", "oecd_code": "QNA / B1_GE",
    ...
    "Gross Domestic Product per Capita (PPP)": {
        "kategori": "1. Economy", "unit": "Current USD PPP", "oecd_code": "SNA / B1_GE_PERCAP",
    ...
    "Gross Fixed Capital Formation (Investment)": {
        "kategori": "1. Economy", "unit": "% of GDP", "oecd_code": "SNA / P51G_PDB",
    ...
    "Consumer Price Index Inflation (Annual)": {
        "kategori": "1. Economy", "unit": "%", "oecd_code": "PRICES_CPI / CPI_TOT",
    ...
    "Nominal Exchange Rate (IDR per USD)": {
        "kategori": "1. Economy", "unit": "IDR per USD (Average)", "oecd_code": "SNA_EXCH / XR_USD",
    ...
    "Foreign Direct Investment (FDI Inflows)": {
        "kategori": "2. Finance and Investment", "unit": "% of GDP", "oecd_code": "FDI / INFLOW_PDB",
        "desc": "Net inward direct investment flows by foreign investors relative to national GDP.",
        "source_url": "https://data-explorer.oecd.org/",
        "data": {"2000": 1.9, "2002": 0.5, "2004": 1.3, "2006": 1.7, "2008": 2.2, "2010": 1.8, "2012": 2.4, "2014": 2.3, "2015": 2.1, "2016": 2.5, "2017": 2.0, "2018": 2.2, "2019": 2.3, "2020": 1.8, "2021": 2.1, "2022": 2.2, "2023": 2.3, "2024": 2.2}
    },

    # --- 3. Employment ---
    "Harmonised Unemployment Rate": {
        "kategori": "3. Employment", "unit": "% of Labor Force", "oecd_code": "LFS_HUR / HUR_TOT",
    ...
    "Labor Force Participation Rate": {
        "kategori": "3. Employment", "unit": "% of Population 15+", "oecd_code": "LFS_POP / LFPR_TOT",
    ...
    "Youth Unemployment Rate (Aged 15-24)": {
        "kategori": "3. Employment", "unit": "% of Youth Labor Force", "oecd_code": "LFS_YOUTH / HUR_YOUTH",
    ...
    "Self-Employment Rate": {
        "kategori": "3. Employment", "unit": "% of Total Employment", "oecd_code": "LFS_SELF / SELF_EMP",
    ...
    "Average Annual Wages": {
        "kategori": "3. Employment", "unit": "Constant USD (PPP)", "oecd_code": "EARN / AV_WAGE",
    ...
    "Labor Productivity Growth": {
        "kategori": "3. Employment", "unit": "Annual % Change", "oecd_code": "PDB_LV / PROD_GROWTH",
        "desc": "Growth rate of GDP per person employed, reflecting overall efficiency of labor utilization.",
        "source_url": "https://data-explorer.oecd.org/",
        "data": {"2000": 2.1, "2002": 1.8, "2005": 3.4, "2008": 3.9, "2010": 3.8, "2012": 3.5, "2015": 2.6, "2016": 2.8, "2017": 2.9, "2018": 3.1, "2019": 2.8, "2020": -2.8, "2021": 2.5, "2022": 3.2, "2023": 2.9, "2024": 2.8}
    },

    # --- 4. Society ---
    "Total Population": {
        "kategori": "4. Society", "unit": "Million Persons", "oecd_code": "DEMO / TOT_POP",
    ...
    "Old-Age Dependency Ratio": {
        "kategori": "4. Society", "unit": "Ratio per 100 Working-Age", "oecd_code": "DEMO_DEP / OLD_DEP",
    ...
    "Poverty Rate (National Poverty Line)": {
        "kategori": "4. Society", "unit": "% of Population", "oecd_code": "SOCX_POV / POV_NAT",
    ...
    "Income Inequality (Gini Coefficient)": {
        "kategori": "4. Society", "unit": "Coefficient (0-1)", "oecd_code": "IDD_GINI / GINI_DISP",
    ...
    "Government Expenditure on Education (% of GDP)": {
        "kategori": "5. Education and Skills", "unit": "% of GDP", "oecd_code": "EDU_FIN / GOV_EDU",
    ...
    "Government Expenditure on Health (% of GDP)": {
        "kategori": "6. Health", "unit": "% of GDP", "oecd_code": "HEALTH_FIN / GOV_HLTH",
    ...
    "CO2 Emissions (Total Greenhouse Gases)": {
        "kategori": "7. Environment and Climate Change", "unit": "Million Tonnes (Mt CO2)", "oecd_code": "ENV_CO2 / TOT_CO2",
        "desc": "Total national anthropogenic carbon dioxide emissions from energy use and industrial processes.",
        "source_url": "https://data-explorer.oecd.org/",
    ...
    "CO2 Emissions per Capita": {
        "kategori": "7. Environment and Climate Change", "unit": "Tonnes per Capita", "oecd_code": "ENV_CO2_PC / CO2_PC",
    ...
    "Renewable Energy Share in Total Energy Supply": {
        "kategori": "7. Environment and Climate Change", "unit": "% of Total Energy", "oecd_code": "NRG_RENEW / REN_SHARE",
    ...
    # --- 8. Public Governance & Finance ---
    "General Government Gross Debt (% of GDP)": {
        "kategori": "8. Public Governance & Finance", "unit": "% of GDP", "oecd_code": "GOV_DEBT / GG_DEBT",
    ...
    "Tax Revenue to GDP Ratio": {
        "kategori": "8. Public Governance & Finance", "unit": "% of GDP", "oecd_code": "REV_TAX / TAX_PDB",
    ...
    "Current Account Balance (% of GDP)": {
        "kategori": "9. Trade", "unit": "% of GDP", "oecd_code": "BOP / CAB_PDB",
    ...
    "Exports of Goods and Services (% of GDP)": {
        "kategori": "9. Trade", "unit": "% of GDP", "oecd_code": "SNA / P6_PDB",
